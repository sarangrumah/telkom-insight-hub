...
import { Upload, FileText, User, Building, CheckCircle, AlertCircle, XCircle, Check, Globe, Phone, MapPin, Briefcase, IdCard, Mail, DollarSign, Building2, Hash, Map, Home } from 'lucide-react';
  ...
  const validateStep = (step: number): boolean => {
    switch (step) {
      ...
      case 3: // Business Details
        if (!formData.business_activity || !formData.business_scale || !formData.business_established_year) {
          setError('Please fill in all required business details fields');
          return false;
        }
        break;
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select name="business_scale" value={formData.business_scale} onValueChange={(value) => handleInputChange({ target: { name: 'business_scale', value } } as unknown as React.ChangeEvent<HTMLSelectElement>)}>
                    <SelectTrigger className="w-full">
