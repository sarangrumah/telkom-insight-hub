-- Create comprehensive sample telekom data for visualization
...
('PT Network Provider Surakarta', 'infrastruktur', 'Penyelenggara Jaringan Tetap Tertutup', 'NET-SKR-018', '2023-02-15', 
 (SELECT id FROM provinces WHERE name = 'Jawa Tengah' LIMIT 1), 
 (SELECT id FROM kabupaten WHERE name = 'Surakarta' LIMIT 1), 
 'active', -7.5755, 110.8243, 'Jawa Tengah'),

('PT Telecom Infrastructure Batam', 'infrastruktur', 'Penyelenggara Jaringan Bergerak Seluler', 'TEL-BTM-019', '2023-03-25', 
...
('PT Innovative Comms Cirebon', 'infrastruktur', 'Penyelenggara Jaringan Tetap Lokal', 'INN-CRB-022', '2024-02-10', 
 (SELECT id FROM provinces WHERE name = 'Jawa Barat' LIMIT 1), 
...
('PT Temporary Service Pekanbaru', 'infrastruktur', 'Penyelenggara Jaringan Bergerak Seluler', 'TMP-PKU-025', '2023-06-15', 
