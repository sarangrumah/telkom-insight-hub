-- Insert sample telecommunications data for testing the map with correct enum values
...
('Hughes Network Systems', 'isr', 'pending', 'Denpasar', -8.6705, 115.2126, '2023-03-15', 'HNS-2023-010'),
